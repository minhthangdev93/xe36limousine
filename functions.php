...
xe36_require_inc( 'about/bootstrap.php' );
xe36_require_inc( 'passenger/bootstrap.php' );
xe36_require_inc( 'cargo/bootstrap.php' );
xe36_require_inc( 'contact/bootstrap.php' );
xe36_require_inc( 'archive/bootstrap.php' );
xe36_require_inc( 'single/bootstrap.php' );
